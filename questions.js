...
const AXES = [
  ...
  { id: "etat",         label: "État & Libertés",            color: "#ffa726", kevinScore: 65 },
  { id: "ecologie",     label: "Écologie",                   color: "#66bb6a", kevinScore: 55 },
  { id: "geopolitique", label: "Géopolitique & Immigration", color: "#29b6f6", kevinScore: 62 },
  { id: "laicite",      label: "Laïcité",                    color: "#ffca28", kevinScore: 70 },
  { id: "justice",      label: "Justice & Sécurité",         color: "#ef5350", kevinScore: 60 },
  { id: "tech",         label: "Technologie",                color: "#26c6da", kevinScore: 78 },
];
